...
def import_weekmenu_list_into_datastore(weeks_menu_list, restaurant_name):
    for weeks_menu in weeks_menu_list:
        import_weekmenu_into_datastore(weeks_menu, restaurant_name)

def import_weekmenu_into_datastore(weeks_menu, restaurant_name):
